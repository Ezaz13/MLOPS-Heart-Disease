...
# The project root is added to sys.path by the entry point script (e.g., ingestion.py)
# All imports should be absolute from the project root (e.g., from src.module)
